...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { name: @passenger.name, number: @passenger.number } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { name: @passenger.name, number: @passenger.number } }
